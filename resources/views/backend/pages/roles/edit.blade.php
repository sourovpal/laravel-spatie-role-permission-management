     ...
     <div class="panel">
        <div class="panel-body">
            <div class="row">
                <div class="col-sm-6">
                    <div class="m-b-30 ">
                        <a href="{{route('dashboard.roles.index')}}" id="addToTable" class="btn btn-primary waves-effect waves-light" style="vertical-align: revert;"><i class="fa fa-eye"></i> View Roles</a>
                    </div>
                </div>
            </div>
            <div>
                <form method="post" action="{{route('dashboard.roles.update', $role->id)}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <input {{\App\Models\CustomData::roleHsaPermission($role, $permissions) ? 'checked' : ''}} class="permission_group" id="permission_group_{{$group->group_name}}" type="checkbox" name="" data-group_name="{{$group->group_name}}">
                            ...
                            <div class="col-lg-10">
                                ...
                                <div class="form-input">
                                    <input {{$role->hasPermissionTo($permission->name) ? 'checked':''}} class="permission_item {{$group->group_name}}" id="{{$permission->name}}" type="checkbox" name="permissions[]" data-group_name="{{$group->group_name}}" value="{{$permission->id}}">
